    ...
    public partial class initDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    kode = table.Column<Guid>(type: "uuid", nullable: false),
                    nama = table.Column<string>(type: "text", nullable: false),
                    alamat = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_gudang", x => x.kode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    kode_gudang = table.Column<Guid>(type: "uuid", nullable: false),
                    GudangKode = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
